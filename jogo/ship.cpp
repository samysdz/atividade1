...
void Ship::initializeGL(GLuint program) {
  ...
  std::array<glm::vec2, 24> positions{
      // Ship body
      glm::vec2{-03.5f, +12.5f}, glm::vec2{-7.5f, +05.5f},
      glm::vec2{-16.5f, -12.5f}, glm::vec2{-03.5f, -09.5f},
      glm::vec2{-04.5f, -12.5f}, glm::vec2{+03.5f, -2.5f},
      glm::vec2{+01.5f, -07.5f}, glm::vec2{+15.5f, -10.5f},

      // Cannon left
      glm::vec2{-17.5f, +15.5f}, glm::vec2{-17.5f, +07.0f},
      glm::vec2{-11.5f, +07.0f}, glm::vec2{-11.5f, +15.5f},
